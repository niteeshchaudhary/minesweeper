 ...
 * 
**/
public class AIPlayer2{ //implements Runnable{
    ...
    public AIPlayer2(int l,int w,int m,ButtonHandler[][] bh) {
    ...
    private void find1(int l,int w) {
         for(int i=0;i<l;i++)
        {
            for(int j=0;j<w;j++)
            {
    ...
    private void delima() {
        ...
        System.out.print("\n nkc delima "+XC+" "+YC+" ");
        if(XC != -12 || YC != -12){
        try{ai_bh[XC][YC].db.doClick();}catch(Exception ex){}
        }
    }
